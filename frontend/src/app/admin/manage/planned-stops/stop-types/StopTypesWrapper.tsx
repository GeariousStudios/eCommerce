...
const StopTypesClient = dynamic(() => import("./StopTypesClient"), {
  ssr: false,
  loading: () => (
    <>
...
const StopTypesWrapper = () => {
  ...
  return <StopTypesClient isConnected={isConnected} />;
};

export default StopTypesWrapper;
