...
const NavbarLink = (props: Props) => {
  ...
  return (
    <>
      <Link
        href={props.href}
        className={`${isActive ? "text-[var(--accent-color)]" : ""} group flex h-[40px] w-[40px] items-center justify-center gap-4 rounded-lg border-1 border-transparent p-2 transition-[background,max-width] duration-[var(--fast)] hover:bg-[var(--bg-navbar-link)] md:w-full md:max-w-full md:justify-between`}
      >
