    ...
    <div className="relative w-full" ref={wrapperRef}>
      ...
      <PortalWrapper>
        <ul
          ...
          className={`${isOpen ? "pointer-events-auto max-h-48 opacity-100" : "max-h-0"} ${options.length >= 4 ? "overflow-y-auto" : "overflow-y-hidden"} fixed z-10 ml-2 list-none rounded-b border-2 border-t-0 border-[var(--border-main)] bg-[var(--bg-main)] opacity-0 transition-[opacity,max-height] duration-[var(--medium)]`}
          role="listbox"
